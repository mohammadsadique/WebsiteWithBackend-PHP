...
if(isset($_POST['sub'])){    
	...
	if($your_img != ''){
        ...
        else 
        {
            ...
            $b = "INSERT INTO `tc_product`( `title`,`link`,`description`, `image`, `date_time`, `date`) VALUES ('$title','$link','$description','$your_imgtt','$date_time','$date')";
            mysqli_query($conn,$b);
            echo "<script>alert('Product added Successfully!');</script>";
	        echo "<script>window.location.href='ourproduct.php';</script>";
        }
	}else{
		$b = "INSERT INTO `tc_product`( `title`,`link`,`description`, `date_time`, `date`) VALUES ('$title','$link','$description','$date_time','$date')";
        mysqli_query($conn,$b);
        echo "<script>alert('Product added Successfully!');</script>";
	    echo "<script>window.location.href='ourproduct.php';</script>";
	}
...
if(isset($_POST['upd'])){
	$id = $_POST['upd'];
	$tt = "SELECT * FROM `tc_product` WHERE `id` = '$id'";
	$ee = mysqli_query($conn,$tt);
	$qq = mysqli_fetch_array($ee);
}else{
	$id = '';
...
if(isset($_POST['update']))
{
    ...
    if($your_img != '')
    {
        ...
        else 
        {
             ...
             move_uploaded_file($_FILES['your_img']['tmp_name'],'../../images/product/'.$your_imgtt);
             $b = "UPDATE `tc_product` SET `title`='$title',`link`='$link',`description`='$description',`image`='$your_imgtt',`date_time`='$date_time',`date`='$date' WHERE `id` = '$id'";
             mysqli_query($conn,$b);
             echo "<script>alert('Update successfully!');</script>";
             echo "<script>window.location.href='ourproduct.php';</script>";
        }
    }else{
        $b = "UPDATE `tc_product` SET `title`='$title',`link`='$link',`description`='$description',`date_time`='$date_time',`date`='$date' WHERE `id` = '$id'";
        mysqli_query($conn,$b);
        echo "<script>alert('Update successfully!');</script>";
        echo "<script>window.location.href='ourproduct.php';</script>";
    }
...
if(isset($_POST['del'])){
	...
	$tt = "DELETE FROM `tc_product` WHERE `id` = '$id'";
