...
if(isset($_POST['sub']))
{
	...
	$bb = "INSERT INTO `tc_officetime`( `tc_news`, `date_time`, `date`) VALUES ('$tc_news','$date_time','$date')";
...
if(isset($_POST['del'])){
	$id = $_POST['del'];
	$tt = "DELETE FROM `tc_officetime` WHERE `id` = '$id'";
...
if(isset($_POST['upd'])){
	$id = $_POST['upd'];
	$tt = "SELECT * FROM `tc_officetime` WHERE `id` = '$id'";
...
if(isset($_POST['update']))
{
	...
	$bb = "UPDATE `tc_officetime` SET `tc_news`='$tc_news',`date_time`='$date_time',`date`='$date' WHERE `id` = '$id'";
	mysqli_query($conn,$bb);
				...
				<div class="box">
					...
					<div class="table-responsive">
						<table class="table table-bordered example1">
							...
							<tbody>
								<?php
									$vv1 = "SELECT * FROM `tc_officetime` ORDER BY id DESC";
