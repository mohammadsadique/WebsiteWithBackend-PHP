...
if(isset($_POST['sub']))
{
	...
	$bb = "INSERT INTO `tc_tutorial`( `link`, `date_time`, `date`) VALUES ('$link','$date_time','$date')";
	mysqli_query($conn,$bb);
	
	echo "<script>alert('Tutorial Link added successfully!');</script>";
	echo "<script>window.location.href='tutorial.php';</script>";
}
if(isset($_POST['del'])){
	$id = $_POST['del'];
	$tt = "DELETE FROM `tc_tutorial` WHERE `id` = '$id'";
...
if(isset($_POST['upd'])){
	$id = $_POST['upd'];
	$tt = "SELECT * FROM `tc_tutorial` WHERE `id` = '$id'";
...
if(isset($_POST['update']))
{
	...
	$bb = "UPDATE `tc_tutorial` SET `link`='$link',`date_time`='$date_time',`date`='$date' WHERE `id` = '$id'";
	mysqli_query($conn,$bb);
	...
	<section class="content">
		<div class="row">
			<div class="col-md-5">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><b>Tutorial Point</b></h3>
					</div>
					<div class="box-body box box-info">
						<form method="post" enctype="multipart/form-data">
							<div class="col-md-12">
								<div class="form-group">
									<label for="exampleInputEmail1">Type Link</label>
									<textarea name="link" class="form-control" rows="3" placeholder="Enter News..."><?php if($id != ''){ echo $qq['link']; } ?></textarea>
								</div>  
							</div>
			...
			<div class="col-md-7">	
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><b>Manage Tutorial Point</b></h3>
					</div>
					<div class="box-body box box-info">
